...
import { Trophy, PhoneCall, Award, Medal, Sparkles, TrendingUp } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <PageHeader
          ...
          description="Track your performance standing against team targets and commission rewards"
        />
      ...
      {/* TOP OPTION TOGGLE: Success Calls vs Points */}
          ...
          <div className="space-y-0.5">
            ...
            <p className="text-sm font-medium text-foreground">
              {rankingMetric === 'success_calls'
                ? 'Ranked by verified student registrations linked to agent calls (Success Calls)'
                : 'Ranked by total commission points earned from registrations and paid tuition fees'}
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div className="p-3 rounded-lg border bg-card text-xs flex items-start gap-2.5">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-0.5">
              When a parent or student you contacted enrolls into the school, that call is credited as a verified Success Call.
            </p>
          </div>
        </div>
        ...
        <div className="p-3 rounded-lg border bg-card text-xs flex items-start gap-2.5">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-0.5">
              Commission credit points awarded automatically each time your attributed students register or pay monthly fees.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="border border-dashed rounded-xl p-16 text-center">
          ...
          <p className="text-xs text-muted-foreground mt-1 max-w-sm mx-auto">
            {timeRange === 'monthly'
              ...
              : 'Rankings will appear once calls and student registrations match.'}
          </p>
        </div>
      ) : (
        <>
              ...
              <Card className="border-primary/40 bg-gradient-to-b from-primary/5 to-transparent relative overflow-hidden">
                ...
                <CardHeader className="pb-2">
                  <div className="flex items-center justify-between">
                    ...
                    {top3[0].agentEmail?.toLowerCase() === currentUserEmail && (
                      <Badge variant="outline" className="text-primary border-primary text-[10px] font-bold">
                        You
                      </Badge>
                    )}
                  </div>
              ...
              <Card className="bg-card">
                <CardHeader className="pb-2">
                  <div className="flex items-center justify-between">
                    ...
                    {top3[1].agentEmail?.toLowerCase() === currentUserEmail && (
                      <Badge variant="outline" className="text-primary border-primary text-[10px] font-bold">
                        You
                      </Badge>
                    )}
              ...
              <Card className="bg-card">
                <CardHeader className="pb-2">
                  <div className="flex items-center justify-between">
                    ...
                    {top3[2].agentEmail?.toLowerCase() === currentUserEmail && (
                      <Badge variant="outline" className="text-primary border-primary text-[10px] font-bold">
                        You
                      </Badge>
                    )}
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription className="text-xs mt-0.5">
                      Visual distribution of {rankingMetric === 'success_calls' ? 'successful student calls' : 'commission points'} across top agents
                    </CardDescription>
                  </div>
              ...
              <CardContent className="pt-2">
                <ChartContainer config={chartConfig} className="h-[220px] w-full">
                  <AreaChart data={chartData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                    <defs>
                      <linearGradient id="agentAreaGradient" x1="0" y1="0" x2="0" y2="1">
            ...
            <Table>
              ...
              <TableBody>
                {sortedData.map((agent, index) => {
                  ...
                  const isMe = agent.agentEmail?.toLowerCase() === currentUserEmail;
                  ...
                  return (
                    <TableRow
                      ...
                      className={
                        isMe
                          ? 'bg-primary/10 border-l-2 border-l-primary font-medium hover:bg-primary/15'
                          : isTop1
                        ...
                        <div className="flex items-center gap-2">
                          <div>
                            <div className="flex items-center gap-1.5">
                              ...
                              {isMe && (
                                <Badge className="bg-primary text-primary-foreground text-[10px] h-4 px-1.5 py-0 font-bold">
                                  You
                                </Badge>
                              )}
                            </div>
